...
class NumberInput():
    ...
    def on_event(self, event):
        if event.type == KEYDOWN:
            if event.unicode.isdigit() and len(self.__strValue) < 12 or (event.unicode == "." and self.__pointsCount == 0):# Tambien podemos usar: if event.unicode in '0123456789'
...
class mainApp():
    ...
    def start(self):
        while True:
            ...
            text = self.entrada.render()# Obtenemos rectángulo blanco y foto del texto y lo asignamos a text
